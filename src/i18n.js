const copy = {
  en: {
    ...
    clueAhead: 'Ahead, one stone face does not match the forest',
    clueCount: 'Trace {n}/1',
    clueNearby: 'Find the shape that does not belong to the forest',
    clueSearch: 'Turn slowly · listen for the stone',
  ...
  zh: {
    ...
    clueAhead: '前方有一处不自然的石面',
    clueCount: '线索 {n}/1',
    clueNearby: '寻找不属于森林的形状',
    clueSearch: '慢慢转动视角 · 留意石头的声音',
